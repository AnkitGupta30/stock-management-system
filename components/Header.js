...
const Header = () => {
  ...
  <div className="container mx-auto max-w-screen-lg flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto opacity-0 lg:opacity-[1] md:opacity-[1] flex flex-wrap items-center text-base justify-center">
